      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-slate-950 rounded-2xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex items-center justify-between">
          ...
          <span className="text-xs font-bold text-emerald-600 hover:underline flex items-center gap-1 cursor-pointer">
            Voir à venir <ArrowRight className="h-3 w-3" />
          </span>
        </div>
        ...
        <div className="bg-white dark:bg-slate-950 rounded-2xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex items-center justify-between">
          ...
          <span className="text-xs font-bold text-amber-600 hover:underline flex items-center gap-1 cursor-pointer">
            Voir l'historique <ArrowRight className="h-3 w-3" />
          </span>
        </div>
        ...
        <div className="bg-white dark:bg-slate-950 rounded-2xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex items-center justify-between">
          ...
          <span className="text-xs font-bold text-red-500 hover:underline flex items-center gap-1 cursor-pointer">
            Voir annulées <ArrowRight className="h-3 w-3" />
          </span>
        </div>
          ...
          {upcomingReservations.map((item) => (
            <div key={item.id} className="bg-white dark:bg-slate-950 rounded-2xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="flex items-center space-x-8 text-xs font-medium text-slate-500">
                ...
                <button className="px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-800 font-bold text-xs text-blue-600 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors flex items-center gap-1">
