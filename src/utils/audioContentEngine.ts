...
export const AUDIO_SCENARIO_DATABASE: AudioScenario[] = [
  ...
  // ─── NIVEAU B2 ───────────────────────────────────────────────────────────
  {
    ...
    structuredDialogue: [
      ...
      { speakerName: "Sophie (Avocate)", voiceProfileId: "sophie-fr-female-young", text: "Exactement. C'est pourquoi je recommande toujours de perfectionner votre production écrite et orale pour garantir ce palier NCLC 7 sans aucune défaillance." }
    ],
    questions: [
      {
        id: 1,
