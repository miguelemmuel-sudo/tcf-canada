...
import { User, Mail, Phone, ChevronDown, Share2 } from "lucide-react";
      ...
      <div className="bg-[#0e2238] text-slate-200 text-xs py-2 px-4 border-b border-slate-700/50">
        <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <div className="flex items-center space-x-6">
            <a href="mailto:contact@griffondor.com" className="flex items-center gap-2 hover:text-amber-400 transition-colors">
              <Mail className="h-3.5 w-3.5" />
              <span>contact@griffondor.com</span>
            </a>
            <a href="tel:+22653360101" className="flex items-center gap-2 hover:text-amber-400 transition-colors">
              <Phone className="h-3.5 w-3.5" />
              <span>+226 53 36 01 01</span>
            </a>
          </div>
          <div className="flex items-center space-x-6">
      ...
      <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="#apropos" className="text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-amber-600 transition-colors">
              À propos
            </Link>
            <div className="relative group flex items-center gap-1 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-amber-600 cursor-pointer">
            ...
            <Link href="#blog" className="text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-amber-600 transition-colors">
              Blog
            </Link>
            <Link href="#contact" className="text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-amber-600 transition-colors">
              Contact
            </Link>
          </nav>
