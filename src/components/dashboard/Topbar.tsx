...
export function Topbar({ userName = "Joel K." }: TopbarProps) {
    ...
    <header className="h-16 bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative w-[340px]">
          <Input
            placeholder="Rechercher un cours, un test..."
            className="pl-4 pr-9 bg-slate-100/70 dark:bg-slate-900 border-none h-9 text-xs font-medium rounded-lg"
          />
